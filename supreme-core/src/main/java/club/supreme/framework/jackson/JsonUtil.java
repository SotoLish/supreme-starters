package club.supreme.framework.jackson;
...
import club.supreme.framework.utils.CollHelper;
...
public final class JsonUtil {
    ...
    public static <T> List<T> parseArray(String content, Class<T> valueTypeRef) {
        try {
            if (!StrUtil.startWith(content, StrPool.BRACKET_START)) {
                content = StrPool.BRACKET_START + content + StrPool.BRACKET_END;
            }
