...
public final class CollHelper {
     ...
     * @return
     */
    public static Map<String, String> getMap(ISupremeBaseEnum[] list) {
        return CollHelper.uniqueIndex(Arrays.asList(list), ISupremeBaseEnum::getCode, ISupremeBaseEnum::getLabel);
    }
