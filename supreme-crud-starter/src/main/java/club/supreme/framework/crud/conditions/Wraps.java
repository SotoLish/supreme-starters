package club.supreme.framework.crud.conditions;


import club.supreme.framework.constant.StrPool;
import club.supreme.framework.crud.conditions.query.LbqWrapper;
import club.supreme.framework.crud.conditions.query.QueryWrap;
import club.supreme.framework.crud.conditions.update.LbuWrapper;
import club.supreme.framework.crud.utils.StrHelper;
...
import static club.supreme.framework.constant.StrPool.PERCENT;
...
public final class Wraps {
    ...
    public static <T> T replace(Object source) {
        ...
        for (Field field : fields) {
            ...
            if (srcValue.contains(PERCENT) || srcValue.contains(StrPool.UNDERLINE)) {
