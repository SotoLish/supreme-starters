...
import club.supreme.framework.web.jackson.EnumModule;
import club.supreme.framework.web.jackson.SupremeJacksonModule;
...
public class JacksonExtendAutoConfiguration {
    ...
    public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
        builder.simpleDateFormat(SupremeConstant.Jackson.DATE_TIME_FORMAT);
        ...
        objectMapper
                ...
                // Date参数日期格式
                .setDateFormat(new SimpleDateFormat(SupremeConstant.Jackson.DATE_TIME_FORMAT, defaultLocale))
                ...
                // 自定义序列化/反序列化规则
                .registerModule(new SupremeJacksonModule())
