package club.supreme.framework.web.aspect;
...
@Slf4j
@Component
@ConditionalOnProperty(value = "supreme.web.logging.enabled", havingValue = "true")
public class WebLoggingAspect {
     ...
     */
    @Pointcut("within(club.supreme.framework..*) || within(club.supreme.module..*)")
